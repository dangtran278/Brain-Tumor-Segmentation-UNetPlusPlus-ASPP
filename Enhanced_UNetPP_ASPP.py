...
save_path = f'checkpoints/runet++aspp_dce{dice_weight:.0e}_invfreqw_adam{learning_rate:.0e}_batch{batch_size}_epoch{num_epochs}.pth'.replace('+0', '').replace('-0', '-')
...
saved_model_path = 'checkpoints/runet++aspp_dce5e-1_invfreqw_adam1e-3_batch32_epoch50.pth'
